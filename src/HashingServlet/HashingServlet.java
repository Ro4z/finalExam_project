...
/**
 * Servlet implementation class HashingServlet
 */
@WebServlet("/HashingServlet")
public class HashingServlet extends HttpServlet {
	 ...
	 */
	public HashingServlet() throws UnsupportedEncodingException {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String pw = info.split("@")[1];
		String name = info.split("@")[2];
		String email = info.split("@")[3];
		key = "Internet Programing 001";
		...
		info = id +"@"+pw+"@"+name+"@"+email;
		HttpSession session = request.getSession();
		String can = "true";
        session.setAttribute("info", info);
        session.setAttribute("canSignUp", can);
        response.sendRedirect("SignUpPage_processed.jsp");
	}
